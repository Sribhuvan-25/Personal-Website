  ...
  if (error) {
    return (
      <div className="pb-4 relative">
        <h2 className="my-20 text-center text-4xl">Projects</h2>
        <div className="flex justify-center items-center h-64">
          <div className="text-lg text-red-500">Error loading projects</div>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        {projects.map((project, idx) => (
          <div 
            ...
            className={`${
              isDarkMode ? 'bg-neutral-900' : 'bg-gradient-to-br from-white via-gray-50 to-cyan-50/30 backdrop-blur-sm'
          ...
          >
            <div className={`relative h-52 overflow-hidden ${
              isDarkMode ? 'bg-gradient-to-br from-neutral-950 to-cyan-950/10' : 'bg-gradient-to-br from-gray-50 to-cyan-100/30'
            }`}>
            ...
            <div className="p-5">
              <div className="flex items-center justify-between mb-3">
                <h3 className={`text-xl font-semibold transition-colors ${
                  isDarkMode ? 'text-white group-hover:text-cyan-300' : 'text-gray-900 group-hover:text-cyan-600'
                }`}>
                  {project.title}
                </h3>
                {project.github && (
                  <button
                    ...
                    className={`rounded-full p-1.5 transition-colors ${
                      isDarkMode ? 'bg-neutral-800 hover:bg-neutral-700' : 'bg-gray-200 hover:bg-gray-300'
                    }`}
                ...
                {project.technologies.map((tech, techIdx) => (
                  <span 
                    ...
                    className={`text-xs px-2 py-1 rounded-full ${
                      isDarkMode ? 'bg-neutral-800 text-cyan-400' : 'bg-cyan-100 text-cyan-700'
                    }`}
                  >
                    {tech}
                  </span>
