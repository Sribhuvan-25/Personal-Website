        ...
        {RESEARCH.map((research, idx) => (
          <motion.div 
            ...
            className={`bg-neutral-900 rounded-xl overflow-hidden shadow-lg transform transition-all duration-300 
              hover:scale-105 hover:shadow-teal-500/20 group cursor-pointer relative`}
        ...
        {expandedId !== null && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              transition={{ duration: 0.3 }}
              className="fixed inset-5 m-auto h-auto max-h-[90vh] w-[95%] max-w-3xl overflow-y-auto bg-neutral-900 rounded-xl shadow-2xl shadow-teal-500/30 z-50"
            >
              <button 
                onClick={(e) => {
                  e.stopPropagation();
              ...
              <div className="flex flex-col lg:flex-row">
                <div className="lg:w-2/5 bg-gradient-to-br from-neutral-950 to-teal-950/20 p-6">
                  ...
                  <h3 className="text-2xl font-bold text-teal-300 mb-2 text-center">
                ...
                <div className="p-6 lg:w-3/5 overflow-y-auto">
                  <h2 className="text-2xl font-bold mb-4 text-teal-300 lg:hidden text-center">
                    {RESEARCH[expandedId].role}
                  </h2>
                  ...
                  <div className="flex flex-wrap gap-2 mt-6 pb-4">
                    {RESEARCH[expandedId].technologies.map((tech, techIdx) => (
                      <span 
                        key={techIdx} 
                        className="bg-neutral-800 text-teal-400 text-sm px-3 py-1.5 rounded-full"
                      >
                        {tech}
                      </span>
                    ))}
